...
template<>
inline VkVertexInputBindingDescription2EXT make<VkVertexInputBindingDescription2EXT>(){
  return VkVertexInputBindingDescription2EXT{VK_STRUCTURE_TYPE_VERTEX_INPUT_BINDING_DESCRIPTION_2_EXT};
}
template <>
...
template<>
inline VkSubmitInfo2 make<VkSubmitInfo2>(){
    return VkSubmitInfo2{VK_STRUCTURE_TYPE_SUBMIT_INFO_2};
}
template<>
inline VkCommandBufferSubmitInfo make<VkCommandBufferSubmitInfo>(){
    return VkCommandBufferSubmitInfo{VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO};
}
template <>
...
template<>
inline VkSemaphoreSubmitInfo make<VkSemaphoreSubmitInfo>(){
    return VkSemaphoreSubmitInfo{VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO};
}
template<>
inline VkRenderingInfo make<VkRenderingInfo>(){
    return VkRenderingInfo{VK_STRUCTURE_TYPE_RENDERING_INFO};
}
template<>
inline VkRenderingAttachmentInfo make<VkRenderingAttachmentInfo>(){
    return VkRenderingAttachmentInfo{VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO};
}
template <>
