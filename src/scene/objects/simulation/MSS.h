...
class Spring {
   public:
    ...
    Spring(const Spring &R) : _Raideur(R._Raideur), _Nu(R._Nu), _L0(R._L0), _Amorti(R._Amorti) {}
...
class Particule {
   public:
    /*! Constructeur */
    inline Particule(const glm::vec3 &C) {
        _Id = 0;
        _Pos = C;
    }
    ...
    inline void SetPosition(const glm::vec3 &C) { _Pos = C; }
